  ...
  return (
    <div className="flex flex-row bg-gradient-to-br from-blue-200 to-violet-400 min-h-screen">
      ...
      <div className="flex flex-col justify-center m-auto bg-indigo-950 w-100 px-16 py-10 rounded-lg">
        ...
        <div className="flex flex-row justify-between w-60 m-auto mb-4">
          {Array(6)
            .fill(0)
            .map((_, index) => (
              <input
        ...
        <button className="text-white bg-gradient-to-br from-blue-400 to-purple-400 w-40 m-auto py-1 rounded-full font-medium">
          Verify OTP
        </button>
      </div>
    </div>
